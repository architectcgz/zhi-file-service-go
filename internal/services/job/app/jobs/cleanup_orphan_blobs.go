...
func (j CleanupOrphanBlobsJob) ExecuteWithResult(ctx context.Context) (Result, error) {
	processed, err := j.repo.CleanupOrphanBlobs(ctx, j.clock.Now().Add(-j.staleAfter), j.batchSize)
